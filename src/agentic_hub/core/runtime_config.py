...
SKILL_LIBRARY_DIR = RUNTIME_DIR / "skills"
SKILL_LIBRARY_FILE = RUNTIME_DIR / "skill_library.json"
SKILL_GAPS_FILE = RUNTIME_DIR / "skill_gaps.json"
SKILL_PROPOSALS_FILE = RUNTIME_DIR / "skill_proposals.json"
SKILL_REVIEWS_FILE = RUNTIME_DIR / "skill_review_reports.json"
